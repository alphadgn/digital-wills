...
const Features = () => {
  ...
  return (
    <section className="py-12 sm:py-16 px-4 sm:px-6 bg-muted/50 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12 text-foreground transition-colors duration-300">Why Choose Digital Wills</h2>
