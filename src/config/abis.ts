    ...
    "inputs": [
      {
        "name": "",
        "type": "uint8",
        "internalType": "enum InheritanceVault.Signer"
      }
    ],
    "outputs": [
      {
    ...
    "outputs": [
      {
        "name": "",
        "type": "address",
        "internalType": "contract IOracleGateway"
      }
    ],
    "stateMutability": "view"
  },
...
/** OracleGateway.sol */
export const ORACLE_GATEWAY_ABI = [
  {
    "type": "function",
    "name": "DEATH_REPORT_TYPEHASH",
    "inputs": [],
    "outputs": [
      {
        "name": "",
